...
| Name                                                                              | Description                                                          |
| --------------------------------------------------------------------------------- | -------------------------------------------------------------------- |
| [opencode-plugin-template](https://github.com/zenobi-us/opencode-plugin-template/) | Official TypeScript template for building OpenCode plugins with best practices |
